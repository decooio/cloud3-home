        ...
        <div className="w-full flex justify-between items-end text-lg">
          <div className="w-[348px] h-[418px] border-2 border-black-1 mt-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <a href="https://ipfs.io" target="_blank" className="text-2xl font-medium leading-7 text-black mt-5 mb-3 underline">IPFS</a>
              <span>the distrbuted file system</span>
              <a href="https://crust.network" target="_blank" className="text-2xl font-medium leading-7 mt-3 mb-2 underline text-black">Crust Network</a>
            ...
            <div className="flex">
              <div className="w-[348px] h-[418px] border-2 border-orange-15">
                ...
                <div className="flex flex-col items-center pt-7 pb-14">
                  ...
                  <h6 onClick={()=>scrollToAnchor('nft')} className="text-2xl font-medium leading-7 mt-[1.7rem] mb-3 underline cursor-pointer">W3Buckets</h6>
                  <span>NFT-nized IPFS storage buckets</span>
                  <h6 onClick={()=>scrollToAnchor('nft')} className="text-2xl font-medium leading-7 mt-3 mb-3 underline cursor-pointer">W3Gateways</h6>
              ...
              <div className="w-[348px] h-[418px] border-2 border-orange-15">
                ...
                <div className="flex flex-col items-center pt-7">
                  ...
                  <h6 onClick={()=>scrollToAnchor('widget')} className="text-2xl font-medium leading-7 mt-[2rem] mb-3 underline cursor-pointer">Web3 Storage Widgets</h6>
